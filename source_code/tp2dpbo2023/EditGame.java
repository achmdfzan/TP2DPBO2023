...
public class EditGame extends javax.swing.JFrame {
     ...
     */
    public EditGame(ListGame listGame, int game_id) {
        initComponents();
        db = new DBConnection();
        ...
        try {
            if (res.next()) {
                ...
                genreField.setText(res.getString("genre"));
                platformField.setText(res.getString("platform"));
                labelIcon.setText(res.getString("image"));
                imageFileName = labelIcon.getText();
            }
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        ...
        if (!nama.isEmpty() && !genre.isEmpty() && !platform.isEmpty() && !image.isEmpty()) {
            System.out.println(game_id + " - " + nama + " - " + genre + " - " + platform + " - " + image);
            String sql = "UPDATE game SET nama = '"+ nama +"', genre = '"+ genre +"', platform = '"+ platform +"', image = '"+ image +"' WHERE game_id = " + game_id;
            db.updateQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditGame(new ListGame(), 0).setVisible(true);
            }
        });
    }
